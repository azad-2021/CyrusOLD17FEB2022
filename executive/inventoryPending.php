    ...
    <tbody>
     ...
     if (!empty($Data))
     {
      ...
      $query2="SELECT * FROM cyrusbackend.demandbase join demandextended on demandbase.OrderID=demandextended.OrderID join cyrusbilling.rates on demandextended.ItemID=rates.ItemID where demandbase.StatusID=2 and demandbase.OrderID=$OrderID and rates.Zone=$ZoneCode";
