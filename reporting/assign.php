            ...
            <tbody >
              ...
              while($rowE=mysqli_fetch_assoc($resultTech)){
                ...
                <tr>
                  ...
                  <td style="color:blue;" class="view_UNO" id="<?php print $EmployeeID; ?>" data-bs-target="#ViewUNO"><?php echo $row3["count(vallordersd.OrderID)"]; ?></td>

                  <td style="color:blue;" class="view_UNC" id="<?php print $EmployeeID; ?>" data-bs-target="#ViewUNC"><?php echo $row["count(ComplaintID)"]; ?></td>

                  <td style="color:blue;" class="view_UAMC" id="<?php print $EmployeeID; ?>" data-bs-target="#ViewUAMC"><?php echo $row2["count(vallordersd.OrderID)"];; ?></td>              
                </tr>
              <?php } ?>
            </tbody>
          </table>
