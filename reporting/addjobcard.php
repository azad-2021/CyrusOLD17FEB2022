      ...
      <form class="needs-validation form-control novalidate my-select4" method="POST">
        <div class="row g-3">
          ...
          <div class="col-sm-3 div">
            ...
            <select class="form-control my-select3" id="exampleFormControlSelect2" name="GadgetID">
          ...
          <div class="col-sm-4 div">
            ...
            <select class="form-control my-select3" id="exampleFormControlSelect2" name="EmployeeID">
              <option value="">Select</option>
              <?php
