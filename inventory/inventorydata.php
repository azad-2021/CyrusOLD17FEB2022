...
<body> 
  ...
  <tbody>
   <?php 
     ...
     //$query2="SELECT * FROM demandbase join orders on demandbase.OrderID=orders.OrderID join branchdetails on orders.BranchCode=branchdetails.BranchCode where StatusID=3 Order By demandbase.OrderID desc";
